<template>
  <b-container>
    ...
    <div class="my-style" v-if="show">
      ...
      <br />
      <b-button class="mt-2 mr-2" variant="primary" v-on:click="toggle">Edit Blog</b-button>
      <b-button class="mr-2 mt-2" variant="primary" v-on:click="removeBlog">Remove Blog</b-button>
      <b-button class="mt-2" variant="primary" v-on:click="cancel">Cancel</b-button>
    </div>
  </b-container>
</template>
...
export default {
  ...
  methods: {
    ...
    removeBlog: function () {
      const answerFlag = confirm("sind Sie sicher?");
      if (answerFlag) {
